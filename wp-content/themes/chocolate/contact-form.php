...
$name_title = esc_attr_x('Ваше имя', 'contact form', LANGUAGE_ZONE);
$email_title = esc_attr_x('E-mail', 'contact form', LANGUAGE_ZONE);
$message_title = esc_attr_x('Сообщение', 'contact form', LANGUAGE_ZONE);
?>
<div class="share_com">
	...
	<div class="article_footer">
		<div id="form_prev_holder">
			<div id="form_holder">
				<div class="header"><?php _ex('Форма связи', 'contact form', LANGUAGE_ZONE); ?></div>
				...
				<form method="post" action="" name="order_form" id="order_form" class="uniform ajax ajaxing">
					...
					<a href="#" class="cont_butt go_submit go_button"><span><i></i><?php _ex('Отправить', 'contact form', LANGUAGE_ZONE); ?></span></a>
					<a href="#" class="do_clear"><?php _ex('Очистить', 'contact  form', LANGUAGE_ZONE); ?></a>
				</form>
