...
function dt_pagenavi($before = '', $after = '') {
	...
	if (!is_single()) {
	   ...
	   $pagenavi_options['first_text'] = __('&laquo; Первый','dt');
	   $pagenavi_options['last_text'] = __('Последние &raquo;','dt');
	   $pagenavi_options['prev_text'] = __('Новые','dt');
	   $pagenavi_options['next_text'] = __('Старые','dt');
