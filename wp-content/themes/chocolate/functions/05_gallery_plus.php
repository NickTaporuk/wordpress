...
function dt_gallery_ct_options( $post ) {
    ...
    $p_orderby = array(
   		'ID'        => __( 'Order by ID', 'dt' ),
        'author'    => __( 'Order by author', 'dt' ),
        'title'     => __( 'Order by title', 'dt' ),
        'date'      => __( 'Order by date', 'dt' ),
        'modified'  => __( 'Order by modified', 'dt' ),
        'rand'      => __( 'Order by rand', 'dt' ),
        'menu_order'=> __( 'Order by menu', 'dt' )
    );
	
	$p_order = array(
		'ASC'	=> __( 'Ascending ', 'dt' ),
		'DESC'	=> __( 'Descending ', 'dt' )
	);
	...
	<p><?php _e('Gallery order options: ', 'dt'); ?></p>
	<p>
