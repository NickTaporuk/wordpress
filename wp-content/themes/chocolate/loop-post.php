...
<?php if(! post_password_required()): ?>
      ...
      <div class="article">
        ...
        ?>>
          <?php
			  ...
			  sprintf( esc_attr__( 'Показать все посты из %s', LANGUAGE_ZONE ), get_the_author() ),
			  get_the_author()
			  );
          ?>
          <?php 
            ...
            if ($post->comment_status!='closed')
               comments_popup_link( __( 'Оставить комментарий', LANGUAGE_ZONE ), __( '1 Комментарии', LANGUAGE_ZONE ), __( '% Комментариев', LANGUAGE_ZONE ), 'ico_link comments' );
          ?>
   ...
   <?php the_post_before(); ?>    
	...
	?>
	<?php wp_link_pages( array( 'before' => '<div class="page-link">' . __( 'Страницы:', 'portfoliopress' ), 'after' => '</div>' ) ); ?>
      </div>
