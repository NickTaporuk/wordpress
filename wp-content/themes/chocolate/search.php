...
<?php if ( have_posts() ) : ?>
    ...
    <div class="article_box col_l">
      ...
      <div class="article search_title">
        ...
        <h1 class="page-title search_title"><?php printf( __( 'Результаты поиска: %s', LANGUAGE_ZONE ), '<span>' . get_search_query() . '</span>' ); ?></h1>
	...
	<div id="content">
		...
		switch( $post->post_type ) {
			case 'dt_gallery_plus': 
				...
				if( post_password_required() ) break;
...
<?php else : ?>
    ...
    <div class="article_box col_l">
      <div class="article_t"></div>
      <div class="article search_title">
        <h1 class="page-title"><?php _e( 'Не найдено', LANGUAGE_ZONE ); ?></h1>
      </div>
      <div class="article_b"></div>
    </div>
