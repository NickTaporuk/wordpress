...
function echo_u($opt)
{
	...
	$dir = $up_dir['baseurl'].'/dt_uploads/';
				...
				<tr valign="top"><th scope="row"><?php _e( $title ); ?></th>
					<td>
					   <div id="<?php echo LANGUAGE_ZONE; ?>_theme_options[<?php echo $id; ?>]_upl"<?php if ( !empty( $options[ $id ] ) ) echo ' style="display: none;"' ?> class="upload">
						...
						<a href="#" id="<?php echo LANGUAGE_ZONE; ?>_theme_options[<?php echo $id; ?>]_cancel"<?php if ( empty( $options[ $id ] ) ) echo ' style="display: none;"' ?>>Cancel</a>
						<label class="description" for="<?php echo LANGUAGE_ZONE; ?>_theme_options[<?php echo $id; ?>]"></label>
						</div>
						<div id="<?php echo LANGUAGE_ZONE; ?>_theme_options[<?php echo $id; ?>]_ok"<?php if ( empty( $options[ $id ] ) ) echo ' style="display: none;"' ?>>
