<?php
   ...
   function ago($time)
   {
      $periods = array(__("секунд", LANGUAGE_ZONE), __("минут", LANGUAGE_ZONE), __("часа", LANGUAGE_ZONE), __("день", LANGUAGE_ZONE), __("неделю", LANGUAGE_ZONE), __("месяц", LANGUAGE_ZONE), __("год", LANGUAGE_ZONE), __("decade", LANGUAGE_ZONE));
